...
async function convertDngToWebp(inputPath, outputPath, resizeWidth = 2048, resizeHeight = 2048) {
  try {
...
// Example usage:
const inputDngPath = './toCover/IMG_2607.DNG';
const outputWebpPath = './haveCOnvert/IMG_2607.webp';
