...
const sendEmail = async (options) => {
  ...
  const mailGenerator = new Mailgen({
    theme: "default",
    product: {
      name: "SundarbanHoneyBd",
      link: "https://www.sundarbanhoneybd.com",
    },
  });
  ...
  const mail = {
    from: "sundarbanhoneybd@gmail.com", // We can name this anything. The mail will go to your Mailtrap inbox
...
const emailVerificationMailgenContent = (username, verificationUrl) => {
  return {
    body: {
      name: username,
      intro:
        "Welcome to SundarbanHoneyBd! We're very excited to have you on board.",
      action: {
        instructions:
...
const orderConfirmationMailgenContent = (username, items, totalCost) => {
  return {
    body: {
      ...
      outro: [
        `Total order cost: BDT ${totalCost}/-`,
